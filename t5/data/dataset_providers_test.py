...
class TasksTest(test_utils.FakeTaskTest):
    ...
    def test_text_line_task(self):
        test_utils.verify_task_matches_fake_datasets(self.text_line_task,
                                                     use_cached=False,
                                                     splits=["train"])

    def test_tf_example_task(self):
        test_utils.verify_task_matches_fake_datasets(self.tf_example_task,
                                                     use_cached=False,
                                                     splits=["train"])
    ...
    def test_cache_exists(self):
        ...
        self.assertEqual(os.path.join(self.test_data_dir, "cached_task"),
    ...
    def test_get_cached_stats(self):
        ...
        with self.assertRaisesRegex(
                ValueError,
                "Stats do not exist for 'cached_task' split: fake"):
    ...
    def test_get_dataset_cached(self):
        test_utils.verify_task_matches_fake_datasets(self.cached_task,
                                                     use_cached=True,
    ...
    def test_get_dataset_onthefly(self):
        test_utils.verify_task_matches_fake_datasets(self.uncached_task,
                                                     use_cached=False,
                                                     token_preprocessed=True)
    ...
    def test_get_dataset_v3(self):
        test_utils.verify_task_matches_fake_datasets(self.task_v3,
                                                     use_cached=False,
                                                     token_preprocessed=True)
    ...
    def test_invalid_token_preprocessors(self):
        ...
        test_utils.add_tfds_task("token_prep_ok",
        ...
        test_utils.add_tfds_task("token_prep_missing_feature",
                                 token_preprocessor=_dummy_preprocessor(
                                     {"inputs": i64_arr([2, 3])}))
        with self.assertRaisesRegex(
                ValueError,
        ...
        test_utils.add_tfds_task("token_prep_wrong_type",
                                 token_preprocessor=_dummy_preprocessor({
                                     "inputs":
                                     "a",
                                     "targets":
        ...
        test_utils.add_tfds_task("token_prep_wrong_shape",
                                 token_preprocessor=_dummy_preprocessor({
                                     "inputs":
                                     i64_arr([2, 3]),
                                     "targets":
        ...
        test_utils.add_tfds_task("token_prep_has_eos",
                                 token_preprocessor=_dummy_preprocessor({
                                     "inputs":
                                     i64_arr([1, 3]),
                                     "targets":
...
class MixturesTest(test_utils.FakeTaskTest):
    def test_tasks(self):
        ...
        for task in mix.tasks:
            test_utils.verify_task_matches_fake_datasets(task,
                                                         use_cached=False)
    ...
    def test_get_dataset_mix(self):
        ...
        res = sum(
            int(item["inputs"][0]) for item in mix_ds.as_numpy_iterator())
    ...
    def test_mixture_of_mixtures_dupe(self):
        ...
        MixtureRegistry.add("yet_another_mix", [("task2_a", 1),
                                                ("task2_b", 1)])
