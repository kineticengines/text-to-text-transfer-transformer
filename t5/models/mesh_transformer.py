...
def get_sentencepiece_model_path(mixture_or_task_name):
  ...
  """
    ...
    elif (isinstance(vocabulary, tuple) and all(
            isinstance(v, t5.data.SentencePieceVocabulary)
            for v in vocabulary)):
        sentencepiece_model_files = set(v.sentencepiece_model_file
                                        for v in vocabulary)
