...
flags.DEFINE_string(
    ...
    "default tpu_worker.")
flags.DEFINE_string("model_dir", "/tmp/transformer_standalone",
                    "Estimator model_dir")
...
flags.DEFINE_list("additional_task_cache_dirs", [],
...
flags.DEFINE_enum("mode", None, [
    "train", "finetune", "eval", "predict", "export_predict", "export_score",
    "score"
], "Mode with which to run the model.")
flags.DEFINE_integer("batch_size", 1, "Number of sequences per batch.")
